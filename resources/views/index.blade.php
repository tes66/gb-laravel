...
@section('content')
    ...
    <div class="col-12">
        <ul class="pagination justify-content-center mb-0">
            ...
            @foreach(range(1, ceil(count($page)/6)) as $item)
                    <li class="page-item @if($item == 1) @if(request()->routeIs('home')) active @endif  @endif"><a class="page-link " href="{{ route('home.page', ['id' => $item - 1]) }}">{{$item}}</a></li>
            @endforeach
